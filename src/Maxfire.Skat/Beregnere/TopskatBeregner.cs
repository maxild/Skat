...
namespace Maxfire.Skat.Beregnere
{
    ...
    public class TopskatBeregner
    {
            ...
            IValueTuple<IKommunaleSatser> kommunaleSatser = null)
        {
            ...
            return grundlagUdenPositivNettoKapitalIndkomst.Map((grundlagAfPersonligIndkomst, index) =>
                new TopskatResult(_skattelovRegistry,
                                  skatteAar,
                                  kommunaleSatser?[index],
                                  grundlagAfPersonligIndkomst,
                                  grundlagAfPositivNettoKapitalIndkomst[index])).ToValueTuple();
        }
        ...
        // ReSharper restore MemberCanBeMadeStatic.Global
        {
            ...
            var grundlagAfPositivNettoKapitalIndkomst
                = BeregnGrundlagAfPositivNettoKapitalIndkomstHelper(indkomster, topskatBundfradrag,
        ...
        private static ValueTuple<decimal> BeregnGrundlagUdenPositivNettoKapitalIndkomstHelper(
            IValueTuple<IPersonligeIndkomster> indkomster,
            decimal topskatBundfradrag)
        {
        ...
        // ReSharper restore MemberCanBeMadeStatic.Global
        {
            return +BeregnGrundlagUdenPositivNettoKapitalIndkomstHelper(indkomster, topskatBundfradrag);
        }
        ...
        // ReSharper restore MemberCanBeMadeStatic.Global
        {
            ...
            return BeregnGrundlagAfPositivNettoKapitalIndkomstHelper(indkomster, topskatBundfradrag,
                positivNettoKapitalIndkomstGrundbeloeb,
        ...
        private static ValueTuple<decimal> BeregnGrundlagAfPositivNettoKapitalIndkomstHelper(
            IValueTuple<IPersonligeIndkomster> indkomster,
            decimal topskatBundfradrag,
            decimal positivNettoKapitalIndkomstGrundbeloeb,
            Func<int, ValueTuple<decimal>, ValueTuple<decimal>> fordelingsnoegleProvider)
        {
            ...
            var grundlagUdenPositivNettoKapitalIndkomst = BeregnGrundlagUdenPositivNettoKapitalIndkomstHelper(indkomster, topskatBundfradrag);
