...
namespace Maxfire.Skat.Beregnere
{
    ...
    public class PersonfradragBeregner
    {
            ...
            int skatteAar)
        {
            ...
            return skatter.Map((skat, index) => ModregningAfSkattevaerdier(skat, skattevaerdier[index], skatteydere[index], kommunaleSatser[index], skatteAar)).ToValueTuple();
        }
            ...
            int skatteAar)
        {
            ...
            var ikkeUdnyttetFradragEgneSkatter = modregnEgneSkatterResults.Map(x => x.IkkeUdnyttetFradrag).ToValueTuple();
            ...
            var skatter = modregnEgneSkatterResults.Map(x => x.Skatter).ToValueTuple();

            var skattevaerdiEgneSkatter = modregnEgneSkatterResults.Map(x => x.Skattevaerdi).ToValueTuple();
            var udnyttedeSkattevaerdierEgneSkatter = modregnEgneSkatterResults.Map(x => x.UdnyttedeSkattevaerdier).ToValueTuple(); // modregninger
            var fradragEgneSkatter = modregnEgneSkatterResults.Map(x => x.Fradrag).ToValueTuple();
            var udnyttetFradragEgneSkatter = modregnEgneSkatterResults.Map(x => x.UdnyttetFradrag).ToValueTuple();
        ...
        public ValueTuple<IndkomstSkatter> BeregnSkattevaerdierAfPersonfradrag(
            ...
            int skatteAar)
        {
            return kommunaleSatser.Map((kommunaleSats, index) => BeregnSkattevaerdierAfPersonfradrag(skatteydere[index], kommunaleSats, skatteAar, skatteydere.Size > 1)).ToValueTuple();
        }
        ...
        {
            return kommunaleSatser.Map((kommunaleSats, index) => BeregnSkattevaerdierAfPersonfradrag(skatteydere[index], kommunaleSats, skatteAar, personfradrag[index])).ToValueTuple();
        }
