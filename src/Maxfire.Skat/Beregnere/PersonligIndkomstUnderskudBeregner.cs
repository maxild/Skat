...
namespace Maxfire.Skat.Beregnere
{
    ...
    public class PersonligIndkomstUnderskudBeregner
    {
        ...
        // ReSharper restore MemberCanBeMadeStatic.Global
        {
            ...
            var aaretsUnderskud = indkomster.Map(x => x.PersonligIndkomstAaretsUnderskud).ToValueTuple();
            ...
            var aaretsRestunderskud = GetRestunderskudEfterEgenOgOverfoertPersonligIndkomstModregning(indkomster,
                aaretsUnderskud, (text, udnyttetUnderskud, index) =>
                    indkomster[index].NedbringUnderskudForPersonligIndkomst(
                        $"Overførsel af årets underskud til {text} personlige indkomst med tillæg af kapitalpensionsindskud",
                        udnyttetUnderskud));
            ...
            var fremfoertUnderskud = indkomster.Map(x => x.PersonligIndkomstFremfoertUnderskud).ToValueTuple();
            ...
            fremfoertRestunderskud = GetRestunderskudEfterEgenOgOverfoertPersonligIndkomstModregning(indkomster,
                fremfoertRestunderskud, (text, udnyttetUnderskud, index) =>
                    indkomster[index].NedbringFremfoertUnderskudForPersonligIndkomst(
                        $"Overførsel af fremført underskud til {text} personlige indkomst med tillæg af kapitalpensionsindskud",
                        udnyttetUnderskud));
        ...
        private static ValueTuple<decimal> GetRestunderskudEfterPersonligIndkomstModregning(
            ...
            ValueTuple<decimal> underskud)
        {
            var personligeIndkomster = indkomster.Map(x => x.PersonligIndkomstSkattegrundlag).ToValueTuple();
            var kapitalPensionsindskud = indkomster.Map(x => x.KapitalPensionsindskudSkattegrundlag).ToValueTuple();
            ...
            restunderskud = modregnKapitalPensionsindskudResults.Map(x => x.IkkeUdnyttetUnderskud).ToValueTuple();
            ...
            ValueTuple<decimal> underskud)
        {
            ...
            return nettokapitalindkomst.Map((kapitalindkomst, index) =>
                Numbers.Min(kapitalindkomst, samletkapitalindkomst, underskud[index]).NonNegative()).ToValueTuple();
        }
    }
