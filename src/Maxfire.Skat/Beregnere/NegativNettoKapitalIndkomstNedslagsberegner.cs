...
namespace Maxfire.Skat.Beregnere
{
    ...
    public class NegativNettoKapitalIndkomstNedslagBeregner
    {
        ...
        // ReSharper restore MemberCanBeMadeStatic.Global
        {
            ...
            var udnyttetNedslag = modregningerFraEgetNedslag.Map(x => x.Sum()).ToValueTuple();
            ...
            var udnyttetOverfortNedslag = modregningerFraOverfoertNedslag.Map(x => x.Sum()).ToValueTuple();
            ...
            return skatter.Map((skat, index) =>
                new ModregnSkatterResult<IndkomstSkatter>(skat, nedslag[index] + overfortUdnyttetNedslag[index],
                    modregningerFraEgetNedslag[index] + modregningerFraOverfoertNedslag[index])).ToValueTuple();
        }
