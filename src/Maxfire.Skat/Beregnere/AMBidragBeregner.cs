...
namespace Maxfire.Skat.Beregnere
{
    ...
    public class AMBidragBeregner : IAMIndkomstSkatteberegner
    {
        ...
        {
            return amIndkomster.Map(amIndkomst => BeregnSkat(amIndkomst, skatteAar)).ToValueTuple();
        }
        ...
        {
            return indkomster.Map(indkomst => BeregnSkat(indkomst, skatteAar)).ToValueTuple();
        }
