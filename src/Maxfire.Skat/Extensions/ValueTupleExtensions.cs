...
namespace Maxfire.Skat.Extensions
{
    public static class ValueTupleExtensions
    {
        ...
        {
            return indkomster.Map((beloeb, index) => Math.Min(beloeb, underskud[index]).NonNegative()).ToValueTuple();
        }
            ...
            ValueTuple<decimal> underskud)
        {
            ...
            return modregninger.Map((modregning, index) => new ModregnIndkomstResult(underskud[index], indkomster[index], modregning)).ToValueTuple();
        }
