...
namespace Maxfire.Skat.Extensions
{
    public static class BeregnModregningerResultExtensions
    {
        ...
        public static ValueTuple<ModregnUnderskudResult> ToModregnResult(
            this ValueTuple<BeregnModregningerResult> beregnModregningerResults,
            ValueTuple<IndkomstSkatterAfPersonligIndkomst> skatter, ValueTuple<decimal> underskud)
        {
            return beregnModregningerResults.Map((result, index) =>
                    new ModregnUnderskudResult(underskud[index], result.ModregningUnderskud,
                        result.ModregningUnderskudSkattepligtigIndkomst, skatter[index], result.ModregningSkatter))
                .ToValueTuple();
        }
    }
}
